...
module RubyAMF
  module Configuration
    ...
    ClassMappings.register(
       :actionscript => 'model.Cliente',
        :ruby => 'Cliente',
        :type => 'active_record',
        :associations => {:default => [] },
        :attributes => {:default => ["id", "nome"]})

    ClassMappings.register(
       :actionscript => 'model.Aluno',
        :ruby => 'Aluno',
        :type => 'active_record',
        :associations => {:default => [] },
        :attributes => {:default => ["id", "nome", "cpf", "data_nascimento"]})
    ...
    ClassMappings.force_active_record_ids = false
    ...
    ClassMappings.default_mapping_scope = :default
