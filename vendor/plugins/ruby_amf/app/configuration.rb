    ...
    class ClassMappings
      ...
      class << self
        ...
        def register(mapping) #register a value object map
          ...
          #primary_key = mapping[:ruby].constantize.primary_key if mapping[:type]=="active_record"
...
#            if !mapping[:attributes].include?(rubyobj.class.primary_key)
##              mapping[:attributes].each_value do |value|
##                value << primary_key
##              end
#              mapping[:attributes] << primary_key
#            end
        ...
        def get_vo_mapping_for_ruby_class(ruby_class)
          ...
          scoped_class_mapping[@current_mapping_scope] ||= (
          if vo_mapping = @class_mappings_by_ruby_class[ruby_class]
